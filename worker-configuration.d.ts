/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 28932373138d8a081ad6140b10afe754)
// Runtime types generated with workerd@1.20260921.1 2024-12-30 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	TELEGRAM_NOTIFY_IN_DEV: string;
	NEXT_PUBLIC_SHOP_PHONE: string;
	NEXT_PUBLIC_TELEGRAM_CHANNEL: string;
	SUPABASE_URL: string;
